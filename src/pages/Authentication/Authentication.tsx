...
export const Authentication = () => {
    ...
    return (
        <div className="w-full h-full flex flex-col justify-center items-center sm:items-start">
            <div className='h-[20%] pt-6 sm:ml-14'>
            ...
            <form className="w-5/6 sm:w-[33rem] h-[80%] flex flex-col gap-y-10 sm:ml-20" onSubmit={handleSubmit}>
                ...
                {authMethod === "sign up" && <div className="flex justify-between">
                        <div className=" h-12 sm:h-14 flex px-5 bg-gray-700 w-[46%] rounded-2xl focus-within:ring-2 ring-blue-500">
                            <div className="w-5/6 h-full flex flex-col justify-center ">
                                ...
                                <input type="text" value={firstname} className='w-full font-bold bg-inherit outline-none' onChange={(e) => setFirstname(e.target.value)} />
                            </div>
                        ...
                        <div className=" h-12 sm:h-14 flex px-5 bg-gray-700 w-[46%] rounded-2xl focus-within:ring-2 ring-blue-500">
                            <div className="w-5/6 h-full flex flex-col justify-center ">
                                ...
                                <input type="text" value={lastname} className='w-full font-bold bg-inherit outline-none' onChange={(e) => setLastname(e.target.value)} />
                            </div>
                            <div className="w-1/6 h-full flex justify-end items-center text-xl text-gray-400"><HiIdentification /></div>
                        </div>
                    </div>}
                    <div className="h-12 sm:h-[3.2rem] w-full flex px-5 bg-gray-700 rounded-2xl focus-within:ring-2 ring-blue-500">
                        <div className="w-5/6 h-full flex flex-col justify-center ">
                            ...
                            <input type="text" value={email} className='w-full font-bold bg-inherit outline-none' onChange={(e) => setEmail(e.target.value)} />
                        </div>
                    ...
                    <div className="h-12 sm:h-[3.2rem] w-full flex px-5 bg-gray-700 rounded-2xl focus-within:ring-2 ring-blue-500">
                        <div className="w-5/6 h-full flex flex-col justify-center ">
                            ...
                            <input type={passwordVisibility} value={password} className='w-full font-bold bg-inherit outline-none' onChange={(e) => setPassword(e.target.value)} />
                        </div>
                ...
                <div className='w-full sm:w-10/12 flex flex-col sm:flex-row items-center gap-y-4 justify-between'>
                    <button type="button" className=" h-12 sm:h-[3.2rem] w-11/12 sm:w-[48%] text-sm font-semibold text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 rounded-3xl flex items-center justify-center">
